...
// Tipos de datos que recibe el celular
  ...
  return (
    <div className="relative w-[320px] h-[650px] lg:w-[360px] lg:h-[720px] bg-black rounded-[3rem] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.4)] border-[10px] border-black overflow-hidden transform transition-all duration-500 hover:scale-[1.01]">
      ...
      <div className="h-full w-full bg-white overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:hidden pb-8">
        ...
        {/* CUERPO */}
        <div className="relative -mt-6 bg-white rounded-t-[1.5rem] px-5 pt-8 pb-10 min-h-[50%] shadow-[0_-5px_20px_rgba(0,0,0,0.1)]">
           ...
           <div className="grid grid-cols-2 gap-2 mb-4">
              <div className="bg-gray-50 p-2.5 rounded-xl border border-gray-100"><span className="block text-[8px] font-bold text-gray-400 uppercase">Raza</span><span className="block text-sm font-bold text-gray-900 truncate">{data.raza || "Ej: Golden"}</span></div>
              <div className="bg-gray-50 p-2.5 rounded-xl border border-gray-100"><span className="block text-[8px] font-bold text-gray-400 uppercase">Edad</span><span className="block text-sm font-bold text-gray-900 truncate">{data.edad || "Ej: 2 Años"}</span></div>
           </div>

           <div className="flex items-center gap-3 mb-4 mt-4 bg-gray-50 p-3 rounded-2xl border border-gray-100">
             ...
             <div><span className="block text-[8px] font-bold text-gray-400 uppercase">Dueño</span><p className="text-sm font-bold text-gray-800">{data.nombre_dueño || "Tu Nombre"}</p></div>
           </div>
