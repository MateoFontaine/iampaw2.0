      ...
      <footer className="bg-white py-12 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-4">
                <a href="https://www.instagram.com/iampawqr/" className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:bg-[#ff6f00] hover:text-white transition-all">
